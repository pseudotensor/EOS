...
c      dum(1)=xintd(0.d0,dum(31),distele,iter)
c      dum(2)=xintd(dum(31),100.d0,distele,iter)
c      dum(3)=0.d0
      dum(1)=xintd(0.d0,1.d0,distele,iter)
      dum(2)=xintd(1.d0,10.d0,distele,iter)
      dum(3)=xintd(10.d0,100.d0,distele,iter)
...
c      tmp(2)=exp(Sqrt(x**2+metilde**2) - etae1) + 1.d0
...
c      tmp(12)=exp(Sqrt(x**2+metilde**2) + etae1) + 1.d0
