...
c      Program reaction_rate_p_electron  !check2
      real*8 function gammannu(T11,etae)
...
c      read(*,*) T11,etae        !check2
      ...
      dum(1)=xintd(0.d0,1.d0,integgammannu,iter)
      dum(2)=xintd(1.d0,10.d0,integgammannu,iter)
      dum(3)=xintd(10.d0,100.d0,integgammannu,iter)
      dum(4)=xintd(100.d0,1000.d0,integgammannu,iter)
      dum(5) = dum(1) + dum(2) + dum(3) + dum(4)


      dum(10)=GF**2/(2.d0*PI**3)*(1.d0+3.d0*ga**2)*tmev**5 !in MeV
      dum(11) =  dum(10) * mevtosec ! in 1/sec
      gammannu= dum(11) * dum(5)
...
C======================================================================
C----------------------------------------------------------------------
      tmp(1)= Sqrt( (x+Qtilde)**2 -metilde**2) * (x+Qtilde)* x**2
      tmp(2)=exp(x) + 1.d0
      tmp(3)=1.d0/(  1.d0 + exp(-(x+metilde - etae1)))
c      integgammannu=tmp(1) / tmp(2)
