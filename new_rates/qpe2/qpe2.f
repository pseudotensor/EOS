...
c     Program cooling_rate_p_electron !check2
      real*8 function qpe2(T11,etae)  !in erg/sec
...
C======================================================================
c      real*8 qpe2                !number deinsty of e- in MeV^3 !check2
...
c      dum(1)=xintd(0.d0,1.d0,integqpe2,iter)
      dum(1)=xintd(0.d0,dum(31),integqpe2,iter)
c      dum(2)=xintd(1.d0,10.d0,integqpe2,iter)
      dum(2)=xintd(dum(31),100.d0,integqpe2,iter)
c      dum(3)=xintd(10.d0,100.d0,integqpe2,iter)
      dum(3)=0.d0
      dum(4)=xintd(100.d0,1000.d0,integqpe2,iter)
      dum(5) = dum(1) + dum(2) + dum(3) + dum(4)

c      np=neint(T11,etae)
      np=1.d0                   !check check

      dum(10)=GF**2/(2.d0*PI**3)*(1.d0+3.d0*ga**2)*np*tmev**6  !in MeV^2
      dum(11) =  dum(10) * mev2toergs ! in erg/sec
      qpe2= dum(11) * dum(5)

c      write(6,100) tmev, etae, qpe2  !check2
...
C======================================================================
c      real*8 integqpe2            !integrand of electrons distribution function
...
C======================================================================
C----------------------------------------------------------------------
      tmp(1)= (x+Qtilde)*Sqrt((x+Qtilde)**2-metilde**2) * x**3
      tmp(2)=ex(x+Qtilde - etae1) + 1.d0
c      tmp(2)=exp(x+Qtilde - etae1) + 1.d0
      integqpe2=tmp(1) / tmp(2)
