...
C======================================================================
      open(11,file="gammapnu.dat",status="unknown")
      open(12,file="imgammapnu",form='unformatted',status="unknown")
